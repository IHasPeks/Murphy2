...
# AI Configuration
OPENAI_API_KEY = "your_openai_api_key_here"  # API Key for OpenAI, used for the AI command
...
QUEUE_STATUS_MESSAGE = "Current queue: {queue_list}"  # {queue_list} will be replaced dynamically
