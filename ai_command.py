...
async def handle_ai_command(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            message.channel, "Sorry, I couldn't process that. Please try again later."
        )
