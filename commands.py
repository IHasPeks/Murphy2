...
async def handle_command(bot, message):
    ...
    if command == "commands":
        ...
        await message.channel.send(
             "Pog? Peks is the definition of Pog. PogChamp"
        )
        ...
        await message.channel.send(
             f"{message.author.mention} is back, yippee"
        )
        ...
        await message.channel.send(
             "Magic 8-ball says: Definitely! Peks agrees."
        )
        ...
        await message.channel.send(
             "Rugo? Actually i wonder where he went?"
        )
    elif command == "teiva":
        await message.channel.send(
